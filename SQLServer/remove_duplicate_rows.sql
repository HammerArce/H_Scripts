/*
https://www.simboli.eu/p/SQL_SERVER_REMOVE_DUPLCIATES_ROW_CERTAIN_COLUMNS
How to remove duplicate rows from a table
Example 1
Let's assume we have a #Students table and we want to DELETE the rows that are duplicated only considering the Name, Surname and Period columns.*/
